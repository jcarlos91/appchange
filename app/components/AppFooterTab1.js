...
export default class AppFooterTab1 extends Component {
				...
				<FooterTab>
					<TouchableOpacity style={styles.footer_content} onPress={() => navigate('Plantilla1Screen')}>
						<MyIcon
							...
							color={'#2A93DF'} 
						/>
						<Text style={{marginTop:3, fontSize:12, color:'#2A93DF'}}>Agentes</Text>
					</TouchableOpacity>
					...
					<TouchableOpacity style={styles.footer_content} onPress={() => navigate('Plantilla1Screen')}>
						<MyIcon
							...
							color={'#939393'} 
						/>
						<Text style={{marginTop:3, fontSize:12, color:'#939393'}}>Perfil</Text>
					</TouchableOpacity>
